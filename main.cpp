...
map<int, map<int, vector<Cruise*>>> graph;
...
{  
    ...
    for (;;)
    {
        ...
        int task_type = stoi(task_type_str);
        string vehicles_types_num_str;
        cout << "Enter wanted vehicles types number> ";
        cin >> vehicles_types_num_str;
        int vehicles_types_num = stoi(vehicles_types_num_str);
        cout << "Enter wanted vehicles types splitted by spaces> ";
        unordered_set<int> vehicles_types;
        for (int i = 0; i < vehicles_types_num; i++)
        {
            string vehicle_type;
            cin >> vehicle_type;
        ...
        switch (task_type)
        {
            ...
            case 2:
            {
                ...
                from_id = station_name_to_id[station_from];
                to_id = station_name_to_id[station_to];
                pair<vector<int>, vector<int>> d_p = dijkstra(from_id, max_station_id + 1, graph, 1, vehicles_types);

                // for (int i = 0; i < d_p.first.size(); i++)
                // {
                //     cout << d_p.first[i] << " ";
                // }
                // cout << endl;
                // for (int i = 0; i < d_p.second.size(); i++)
                // {
                //     cout << d_p.second[i] << " ";
                // }
                // cout << endl;

                int current_station = to_id;
            ...
            case 5:
            {
                ...
                int from_id, limit_time;
                from_id = station_name_to_id[station_from];
                limit_time = stoi(limit_time_str);
                pair<vector<int>, vector<int>> d_p = dijkstra(from_id, max_station_id + 1, graph, 0, vehicles_types);
